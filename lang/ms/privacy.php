...
return [
    ...
    'meta' => [
        'title' => 'Notis privasi - JubahPanda',
    ],

    'language' => 'Bahasa Melayu',
    'title' => 'Notis privasi',
    'updated' => 'Versi :version',
    'intro' => 'Notis ini menerangkan bagaimana JubahPanda mengendalikan data peribadi yang anda berikan semasa mendaftar, seperti yang dikehendaki oleh Akta Perlindungan Data Peribadi 2010 (Malaysia).',

    'sections' => [
        'who' => [
            'title' => 'Siapa kami',
            'body' => 'JubahPanda ialah perkhidmatan runner jubah konvokesyen yang bebas untuk graduan UMPSA. Kami bukan sebahagian daripada UMPSA. Anda boleh menghubungi kami melalui WhatsApp di :whatsapp atau emel di :email untuk sebarang pertanyaan mengenai data anda.',
        ],
        'what' => [
        ...
        'source' => [
            ...
            'body' => 'Daripada anda, melalui borang pendaftaran atau di WhatsApp.',
        ],
        'disclosure' => [
        ...
        'retention' => [
            ...
            'body' => 'Satu tahun dari pendaftaran anda, selepas itu ia dipadam. Salinan sandaran mungkin menyimpannya sehingga 14 hari lagi.',
        ],
        'rights' => [
            'title' => 'Hak anda',
            'body' => 'Anda boleh meminta untuk melihat data yang kami simpan tentang anda, meminta kami membetulkannya, atau menarik balik persetujuan anda, yang bermaksud kami memadamkannya. Mesej kami di WhatsApp atau emel kami. Jika anda menarik balik persetujuan sebelum jubah anda diambil, kami mungkin tidak dapat melengkapkan tempahan anda.',
        ],
        'security' => [
            'title' => 'Bagaimana kami melindunginya',
            'body' => 'Akses terhad kepada pasukan kami melalui akaun berkata laluan. Kami tidak meminta atau menyimpan nombor kad pengenalan anda, dan kami tidak menyimpan dokumen pengenalan di laman web ini.',
        ],
    ],
